...
void testCopy2() {
        ...
        int arr[] = {2, 3, 4, 8, 9}; // this list
        SLLSet listObj2 =  SLLSet(arr,5);
		SLLSet copied = listObj2.copy();
        copied.add(100);
        string expectedObj2 = "2, 3, 4, 8, 9";
        string expectedCopied = "2, 3, 4, 8, 9, 100";
        int expectedObj2Size = 5;
        int expectedCopiedSize = 6;
...
void testUnion5() {
        // test union
    int arr[] = {1, 2, 3, 4, 5}; // this list
    SLLSet listObj2 =  SLLSet(arr,5);
    int uni1[] = {0, 2, 3, 5, 6, 7};
...
void testDifference5() {
    ...
    int diff2[] = {3, 7, 8}; // test difference
    // test difference
    SLLSet listObj21 = SLLSet(diff2,3);
    SLLSet listObj22 = listObj2.difference(listObj21);
